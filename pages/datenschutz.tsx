...
const Datenschutz = () => {
    return (
        <>
            <Head>
                <title>Datenschutzerklärung - RP Schliesstechnik</title>
                <meta name="description" content="Datenschutzerklärung von RP Schliesstechnik - Informationen zum Umgang mit Ihren personenbezogenen Daten." />
                <meta name="robots" content="noindex, follow" />
            </Head>
            <div className={homeStyles.container}>
                <div className={styles.container} style={{ padding: '2rem', fontFamily: 'Arial, sans-serif', lineHeight: '1.6' }}>
                    <h1 style={{ textAlign: 'center', marginBottom: '2rem' }}>Datenschutzerklärung</h1>
                    ...
                    <section>
                        ...
                        <p>
                            ...
                            E-Mail: <a href="mailto:info@schluesselrp.de">info@schluesselrp.de</a>
                        </p>
                        <p>
                    ...
                    <section style={{ marginTop: '2rem', paddingTop: '1rem', borderTop: '1px solid #ccc' }}>
                        <p>
                            <Link href="/impressum" style={{ color: '#0070f3', textDecoration: 'underline' }}>
                                Zum Impressum
                            </Link>
                        </p>
